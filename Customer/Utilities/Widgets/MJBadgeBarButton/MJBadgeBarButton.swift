...
class MJBadgeBarButton: UIBarButtonItem {
    ...
    func setup(customButton: UIButton) {
        ...
        self.badgeBGColor = UIColor.clear
        self.badgeTextColor = UIColor.white
        self.badgeFont = UIFont.systemFont(ofSize: 8.0)
        self.badgePadding = 4.0
        self.badgeMinSize = 4.0
        self.badgeOriginX = 0
        self.badgeOriginY = 0
        ...
        self.badge = UILabel(frame: CGRect(x: self.badgeOriginX, y: self.badgeOriginY, width: 4.0, height: 4.0))
